...
class AutoHealer:
    ...
    def __init__(self, hk_vel, hk_mana_ring, hk_cura, hk_vida_pot, hk_mana_pot, hk_food, hk_cura_media, hk_troca_ring, loc_top_status, loc_bot_status):
        #imagens
    ...
    def cura_vida_media(self):
        self.screenshot = self.wincap.get_screenshot()
        #curar vida
        b, g, r = self.screenshot[self.loc_vida[1], self.loc_vida[0]+90]
        #print(r, g, b, self.loc_vida[0], self.loc_vida[1])
